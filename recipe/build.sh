...
cmake ${CMAKE_ARGS} -DGDAL_CSHARP_ONLY=ON -DBUILD_TESTING=ON -DCSHARP_LIBRARY_VERSION=Net10.0 -DCSHARP_APPLICATION_VERSION=Net10.0 -DCMAKE_POLICY_DEFAULT_CMP0190=OLD "-DCMAKE_PREFIX_PATH=${CONDA_PREFIX}" -S . -B ../build
